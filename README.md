...
|--------|-------------|------|
| [Capture](prompts/capture.md) | Detects events (errors, corrections, discoveries) and writes to `log.md` | During session, via `postToolUse` and `userPromptSubmit` hooks |
